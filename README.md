...
It is my belief that today's existing conundrums can be addressed in a similar fashion. By combining different known solutions with new ideas led by the thinking that gave rise to the solutions we presently have it will be possible to go beyond the limitations of today's technology where new impossible problems will be found. It is only by learning, experimenting, failing, and sharing our results that we can hope to achieve these breakthroughs. To that end, please send any suggestions, bug fixes, corrections, or observations to my email address in my profile. Beyond that, clone this repo, open it, and make something better to share, if you do, kindly mention me in the readme.  
